...
{
    /// <inheritdoc />
    public partial class PopularLanchesECategorias : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO Categorias(Nome" +
                ",Descricao) " +
                "VALUES('Natural','Lanche feito com ingredientes integrais e naturais')");

            migrationBuilder.Sql("INSERT INTO Itens(CategoriaId,DescricaoCurta,DescricaoDetalhada,EmEstoque,ImagemThumbnailUrl,ImagemUrl,IsItemPreferido,Nome,Preco)" +
            ...
            migrationBuilder.Sql("INSERT INTO Itens(CategoriaId,DescricaoCurta,DescricaoDetalhada,EmEstoque,ImagemThumbnailUrl,ImagemUrl,IsItem" +
                "Preferido,Nome,Preco)" +
